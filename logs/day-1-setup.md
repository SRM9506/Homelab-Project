...
the foundation for my virtualization, networking, and security labs.
...
- Deployed Nextcloud personal cloud storage
...
**Problem:** Proxmox was not reachable via the web GUI; the terminal was
restricted to IPv6, and standard network commands returned "temporary
...
- Updated `/etc/network/interfaces` to define a static IPv4 address
  and added Google DNS
- Validated connectivity via ICMP echo, confirming the physical layer
  was functional
