...
- Deployed Jellyfin media server (http://192.168.1.156:8096)
- Deployed Nextcloud personal cloud storage (http://192.168.1.156:8080)
- Deployed Nginx Proxy Manager (http://192.168.1.156:81)
...
(192.168.1.200) and added Google DNS (8.8.8.8, 8.8.4.4)
...
| Service | URL | Purpose |
|---|---|---|
| Proxmox | https://192.168.1.200:8006 | Hypervisor management |
| Jellyfin | http://192.168.1.156:8096 | Personal media server |
| Nextcloud | http://192.168.1.156:8080 | Personal cloud storage |
| Nginx Proxy Manager | http://192.168.1.156:81 | Reverse proxy |
