...
| Jellyfin | http://192.168.1.156:8096 | 1TB HDD |
| Nextcloud | http://192.168.1.156:8080 | 1TB HDD |
| Nginx Proxy Manager | http://192.168.1.156:81 | - |
| Portainer | http://192.168.1.156:9000 | - |
| Uptime Kuma | http://192.168.1.156:3001 | - |
...
- **Resolution:** Used chown to transfer ownership to correct users 
  (shark742 for general folders, www-data uid 33 for Nextcloud)
